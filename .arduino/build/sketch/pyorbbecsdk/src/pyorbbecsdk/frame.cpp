#line 1 "/home/admin/git/shortpod_mustard_robot_arm/pyorbbecsdk/src/pyorbbecsdk/frame.cpp"
/*******************************************************************************
...
void define_frame(const py::object& m) {
  py::class_<ob::Frame, std::shared_ptr<ob::Frame>>(m, "Frame")
      ...
      .def(
          "get_data_pointer",
          [](const std::shared_ptr<ob::Frame>& self) -> py::object {
            OB_TRY_CATCH({
              auto ptr = self->data();
      ...
      .def("as_confidence_frame",
           [](const std::shared_ptr<ob::Frame>& self)
               -> std::shared_ptr<ob::ConfidenceFrame> {
      ...
      .def("as_lidar_points_frame",
           [](const std::shared_ptr<ob::Frame>& self)
               -> std::shared_ptr<ob::LiDARPointsFrame> {
