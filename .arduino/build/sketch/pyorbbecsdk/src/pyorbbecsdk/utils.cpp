#line 1 "/home/admin/git/shortpod_mustard_robot_arm/pyorbbecsdk/src/pyorbbecsdk/utils.cpp"
/*******************************************************************************
  ...
  m.def(
      ...
      .def("save_lidar_point_cloud_to_ply",
           [](const char* file_name,
              std::shared_ptr<ob::LiDARPointsFrame> frame, bool save_binary) {
             OB_TRY_CATCH({
               ob::PointCloudHelper::saveLiDARPointcloudToPly(file_name, frame,
                                                              save_binary);
             });
           });
}
