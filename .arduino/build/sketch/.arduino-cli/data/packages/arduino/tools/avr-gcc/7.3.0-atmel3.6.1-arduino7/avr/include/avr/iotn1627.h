#line 1 "/home/admin/git/shortpod_mustard_robot_arm/.arduino-cli/data/packages/arduino/tools/avr-gcc/7.3.0-atmel3.6.1-arduino7/avr/include/avr/iotn1627.h"
/*****************************************************************************
 *
...
typedef enum ADC_MUXPOS_enum
{
    ...
    ADC_MUXPOS_DAC_gc = (0x33<<0),  /* DAC */
} ADC_MUXPOS_t;

/* PGA BIAS Select select */
typedef enum ADC_PGABIASSEL_enum
{
    ADC_PGABIASSEL_1X_gc = (0x00<<3),  /* 1x BIAS curren */
...
typedef enum EVSYS_CHANNEL4_enum
{
    ...
    EVSYS_CHANNEL4_PORTC_PIN6_gc = (0x4E<<0),  /* Port C Pin 6 */
    EVSYS_CHANNEL4_PORTC_PIN7_gc = (0x4F<<0),  /* Port C Pin 7 */
...
typedef enum EVSYS_CHANNEL5_enum
{
    ...
    EVSYS_CHANNEL5_PORTC_PIN6_gc = (0x4E<<0),  /* Port C Pin 6 */
    EVSYS_CHANNEL5_PORTC_PIN7_gc = (0x4F<<0),  /* Port C Pin 7 */
...
typedef enum TCA_SPLIT_CMDEN_enum
{
    ...
    TCA_SPLIT_CMDEN_BOTH_gc = (0x03<<0),  /* Both low byte and high byte */
} TCA_SPLIT_CMDEN_t;
...
#define ADC_TIMEBASE0_bm  (1<<3)  /* Reference Selection bit 0 mask. */
#define ADC_TIMEBASE0_bp  3  /* Reference Selection bit 0 position. */
#define ADC_TIMEBASE1_bm  (1<<4)  /* Reference Selection bit 1 mask. */
#define ADC_TIMEBASE1_bp  4  /* Reference Selection bit 1 position. */
#define ADC_TIMEBASE2_bm  (1<<5)  /* Reference Selection bit 2 mask. */
#define ADC_TIMEBASE2_bp  5  /* Reference Selection bit 2 position. */
#define ADC_TIMEBASE3_bm  (1<<6)  /* Reference Selection bit 3 mask. */
#define ADC_TIMEBASE3_bp  6  /* Reference Selection bit 3 position. */
#define ADC_TIMEBASE4_bm  (1<<7)  /* Reference Selection bit 4 mask. */
#define ADC_TIMEBASE4_bp  7  /* Reference Selection bit 4 position. */
...
#define ADC_SAMPDUR0_bm  (1<<0)  /* Sampling time bit 0 mask. */
#define ADC_SAMPDUR0_bp  0  /* Sampling time bit 0 position. */
#define ADC_SAMPDUR1_bm  (1<<1)  /* Sampling time bit 1 mask. */
#define ADC_SAMPDUR1_bp  1  /* Sampling time bit 1 position. */
#define ADC_SAMPDUR2_bm  (1<<2)  /* Sampling time bit 2 mask. */
#define ADC_SAMPDUR2_bp  2  /* Sampling time bit 2 position. */
#define ADC_SAMPDUR3_bm  (1<<3)  /* Sampling time bit 3 mask. */
#define ADC_SAMPDUR3_bp  3  /* Sampling time bit 3 position. */
#define ADC_SAMPDUR4_bm  (1<<4)  /* Sampling time bit 4 mask. */
#define ADC_SAMPDUR4_bp  4  /* Sampling time bit 4 position. */
#define ADC_SAMPDUR5_bm  (1<<5)  /* Sampling time bit 5 mask. */
#define ADC_SAMPDUR5_bp  5  /* Sampling time bit 5 position. */
#define ADC_SAMPDUR6_bm  (1<<6)  /* Sampling time bit 6 mask. */
#define ADC_SAMPDUR6_bp  6  /* Sampling time bit 6 position. */
#define ADC_SAMPDUR7_bm  (1<<7)  /* Sampling time bit 7 mask. */
#define ADC_SAMPDUR7_bp  7  /* Sampling time bit 7 position. */
...
#define ADC_ADCPGASAMPDUR0_bm  (1<<1)  /* ADC PGA Sample Duration bit 0 mask. */
#define ADC_ADCPGASAMPDUR0_bp  1  /* ADC PGA Sample Duration bit 0 position. */
#define ADC_ADCPGASAMPDUR1_bm  (1<<2)  /* ADC PGA Sample Duration bit 1 mask. */
#define ADC_ADCPGASAMPDUR1_bp  2  /* ADC PGA Sample Duration bit 1 position. */
...
#define CLKCTRL_CLKSEL0_bm  (1<<0)  /* clock bit 0 mask. */
#define CLKCTRL_CLKSEL0_bp  0  /* clock bit 0 position. */
#define CLKCTRL_CLKSEL1_bm  (1<<1)  /* clock bit 1 mask. */
#define CLKCTRL_CLKSEL1_bp  1  /* clock bit 1 position. */
...
#define EVSYS_SWEVENTA0_bm  (1<<0)  /* Software event on channel bit 0 mask. */
#define EVSYS_SWEVENTA0_bp  0  /* Software event on channel bit 0 position. */
#define EVSYS_SWEVENTA1_bm  (1<<1)  /* Software event on channel bit 1 mask. */
#define EVSYS_SWEVENTA1_bp  1  /* Software event on channel bit 1 position. */
#define EVSYS_SWEVENTA2_bm  (1<<2)  /* Software event on channel bit 2 mask. */
#define EVSYS_SWEVENTA2_bp  2  /* Software event on channel bit 2 position. */
#define EVSYS_SWEVENTA3_bm  (1<<3)  /* Software event on channel bit 3 mask. */
#define EVSYS_SWEVENTA3_bp  3  /* Software event on channel bit 3 position. */
#define EVSYS_SWEVENTA4_bm  (1<<4)  /* Software event on channel bit 4 mask. */
#define EVSYS_SWEVENTA4_bp  4  /* Software event on channel bit 4 position. */
#define EVSYS_SWEVENTA5_bm  (1<<5)  /* Software event on channel bit 5 mask. */
#define EVSYS_SWEVENTA5_bp  5  /* Software event on channel bit 5 position. */
#define EVSYS_SWEVENTA6_bm  (1<<6)  /* Software event on channel bit 6 mask. */
#define EVSYS_SWEVENTA6_bp  6  /* Software event on channel bit 6 position. */
#define EVSYS_SWEVENTA7_bm  (1<<7)  /* Software event on channel bit 7 mask. */
#define EVSYS_SWEVENTA7_bp  7  /* Software event on channel bit 7 position. */
...
#define EVSYS_USER0_bm  (1<<0)  /* Channel selector bit 0 mask. */
#define EVSYS_USER0_bp  0  /* Channel selector bit 0 position. */
#define EVSYS_USER1_bm  (1<<1)  /* Channel selector bit 1 mask. */
#define EVSYS_USER1_bp  1  /* Channel selector bit 1 position. */
#define EVSYS_USER2_bm  (1<<2)  /* Channel selector bit 2 mask. */
#define EVSYS_USER2_bp  2  /* Channel selector bit 2 position. */
#define EVSYS_USER3_bm  (1<<3)  /* Channel selector bit 3 mask. */
#define EVSYS_USER3_bp  3  /* Channel selector bit 3 position. */
#define EVSYS_USER4_bm  (1<<4)  /* Channel selector bit 4 mask. */
#define EVSYS_USER4_bp  4  /* Channel selector bit 4 position. */
#define EVSYS_USER5_bm  (1<<5)  /* Channel selector bit 5 mask. */
#define EVSYS_USER5_bp  5  /* Channel selector bit 5 position. */
#define EVSYS_USER6_bm  (1<<6)  /* Channel selector bit 6 mask. */
#define EVSYS_USER6_bp  6  /* Channel selector bit 6 position. */
#define EVSYS_USER7_bm  (1<<7)  /* Channel selector bit 7 mask. */
#define EVSYS_USER7_bp  7  /* Channel selector bit 7 position. */
...
#define RTC_CLKSEL_gm  0x03  /* Clock group mask. */
#define RTC_CLKSEL_gp  0  /* Clock group position. */
#define RTC_CLKSEL0_bm  (1<<0)  /* Clock bit 0 mask. */
#define RTC_CLKSEL0_bp  0  /* Clock bit 0 position. */
#define RTC_CLKSEL1_bm  (1<<1)  /* Clock bit 1 mask. */
#define RTC_CLKSEL1_bp  1  /* Clock bit 1 position. */
...
#define TCB_CLKSEL_gm  0x0E  /* TCB Clock group mask. */
#define TCB_CLKSEL_gp  1  /* TCB Clock group position. */
#define TCB_CLKSEL0_bm  (1<<1)  /* TCB Clock bit 0 mask. */
#define TCB_CLKSEL0_bp  1  /* TCB Clock bit 0 position. */
#define TCB_CLKSEL1_bm  (1<<2)  /* TCB Clock bit 1 mask. */
#define TCB_CLKSEL1_bp  2  /* TCB Clock bit 1 position. */
#define TCB_CLKSEL2_bm  (1<<3)  /* TCB Clock bit 2 mask. */
#define TCB_CLKSEL2_bp  3  /* TCB Clock bit 2 position. */
